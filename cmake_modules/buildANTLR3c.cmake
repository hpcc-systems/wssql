...
IF (NOT ANTLR3c_FOUND)
    ...
    SET (ANTLR_LICENSE_URL "https://raw2.github.com/antlr/antlr4/master/LICENSE.txt")
    ...
    ADD_CUSTOM_COMMAND(
        ...
        COMMAND wget -O ./ANTLR-LICENSE.txt ${ANTLR_LICENSE_URL}
    ...
    INSTALL(FILES ${ANTLR_LICENSE_NAME} DESTINATION ${EXTERN_LIB_PATH} COMPONENT Runtime)
